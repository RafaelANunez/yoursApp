...
const SecondaryHomeScreen = ({ navigation }) => {
  ...
  // --- FIX: Added 'user?.profilePic' to match your UserProfileSettingsPage ---
  ...
  // Helper to handle navigation ensuring triggers are sent
  const handleNavigation = (feature) => {
     if (feature.route === 'Home') {
         // We are going back to home with a specific trigger
         navigation.navigate({
             name: 'Home',
             params: { 
             ...
             merge: true, // Important: merge params with existing home screen route
         });
     } else {
          ...
          <View style={styles.topBar}>
            ...
            <View style={styles.profileSection}>
                ...
                <View style={styles.profileInfo}>
                 ...
                 {/* Added a small settings shortcut icon to the right of profile */}
